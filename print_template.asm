...
DISPLAY_MSG:
    ...
    mov AX, CS              ; Once again, we use AX to store the value of CS to transfer it to another segment which is DS.
    mov DS, AX              ; DS receives the value from CS through AX.  This ensures that data references in the code will be relative to the code segment's base address.
    SHOW:
